...
final class Camera {
    ...
    class func shouldStartCamera(target: AnyObject, canEdit: Bool, frontFacing: Bool) -> Bool {
        ...
        if target is ChatConversationViewController {
            cameraUI.delegate = target as! ChatConversationViewController
        }
    ...
    class func shouldStartPhotoLibrary(target: AnyObject, mediaType: MediaType, canEdit: Bool) -> Bool {
        ...
        if target is ChatConversationViewController {
            imagePicker.delegate = target as! ChatConversationViewController
        }
